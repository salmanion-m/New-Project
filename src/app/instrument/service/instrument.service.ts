...
export class InstrumentService {
  ...
  // getInstrument(): Observable<InstrumentList[]> {
  //   return this.http.get<InstrumentList[]>(`${environment.apiUrl}/Instrument`, {headers: header})
  // }
  ...
  getInstrument(): Observable<InstrumentList[]> {
    ...
    return this.http.get<InstrumentList[]>(`${this._apiUrl}`, {headers: header})
  }
